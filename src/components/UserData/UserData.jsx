    ...
    return (
        <section className="user-card">
            ...
            <div className="user-bottom">
                <div className="links">
                    <div className={`link-wrapper ${!props.user.location ? "not-available" : ""}`}>
                    ...
                    <div className={`link-wrapper ${!props.user.blog ? "not-available" : ""}`}>
                        <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                            <g fill="currentColor">
                ...
                <div className="links">
                    ...
                    <div className={`link-wrapper ${!props.user.company ? "not-available" : ""}`}>
                        <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                            <g fill="currentColor">
                        ...
                        {displayCompany(props.user.company)}
                    </div>
                </div>
            </div>
        </section>
